export const translations = {
  en: {
    ...
    features: {
      ...
      titleHighlight: "converting video content",
      subtitle: "Professional video creation tools powered by advanced AI technology",
      items: [
        {
    ...
    howItWorks: {
      ...
      subtitle: "Create professional videos in three simple steps",
      steps: [
        {
    ...
    finalCta: {
      ...
      subtitle: "Join thousands of creators who are already making high-converting videos with AI"
    },
...
// Helper to get translations for a specific locale
